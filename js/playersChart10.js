async function playersChart10(e)
{
...
gamelist2 = await getSteamSpyTop100(currentProxy)
    ...
    for(i = 0; i < 10; i++) //definicja tablicy z losowymi kolorami dla słupków
        {
    ...
    data: {
        labels: names,
        datasets: [{
        label: 'Podzial ilości graczy w 10 najpopularniejszych grach',
        data: p_count,
        backgroundColor,
        borderColor,
        borderWidth: 1
