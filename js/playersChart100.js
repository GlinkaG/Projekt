async function playersChart100(e)
{
...
gamelist2 = await getSteamSpyTop100(currentProxy)
    ...
    for(i = 0; i < 100; i++) //definicja tablicy z losowymi kolorami dla słupków
        {
    ...
    data: {
        labels: names,
        datasets: [{
        label: 'Podzial ilości graczy w 100 najpopularniejszych grach',
        data: p_count,
        backgroundColor,
        borderColor,
        borderWidth: 1
